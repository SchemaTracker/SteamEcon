...
using Dota2InternalTestSchema;

namespace SteamEcon.Schema.Dota2InternalTestSchema
{
    public class Dota2InternalTestSchema
    {
        ...
        public IList<Dota2InternalTestSchemaAttribute> Attributes { get; set; }
...
namespace Dota2InternalTestSchema
{
    ...
    public class Dota2InternalTestSchemaAttribute
    {
